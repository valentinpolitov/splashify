...
export const iOSDevices: Device[] = [
  ...
  { width: 414, height: 896, dpi: 3 },
  // iPhone 13 Mini, iPhone 12 Mini, iPhone 11 Pro, iPhone XS, iPhone X
  { width: 375, height: 812, dpi: 3 },
  // iPhone 11, iPhone XR
  { width: 414, height: 896, dpi: 2 },
  // iPhone 8 Plus, iPhone 7 Plus
  { width: 414, height: 736, dpi: 3 },
  // iPhone SE 2nd Gen and later, iPhone 8, iPhone 7
  { width: 375, height: 667, dpi: 2 },
  // `[Legacy]` iPhone SE 4, iPhone 5s, iPhone 5c, iPhone 5, iPod Touch 5th Gen and later
  { width: 320, height: 568, dpi: 2 },
  // iPad Pro 7th Gen 11"
  { width: 834, height: 1210, dpi: 2 },
  // iPad Pro 13"
  { width: 1032, height: 1376, dpi: 2 },
  // iPad Air 13", iPad Pro 12.9", iPad Air 9.7", iPad Mini 7.9"
  { width: 1024, height: 1366, dpi: 2 },
  // iPad Pro 3-6th Gen 11"
  { width: 834, height: 1194, dpi: 2 },
  // iPad Air 4-6th Gen 11", iPad 10th Gen
  { width: 820, height: 1180, dpi: 2 },
  // iPad Air 3rd Gen 10.5", iPad Pro 2nd Gen 10.5"
  { width: 834, height: 1112, dpi: 2 },
  // iPad 7-9th Gen 10.2"
  { width: 810, height: 1080, dpi: 2 },
  // iPad Mini 6th Gen and later
  { width: 744, height: 1133, dpi: 2 },
  // iPad Mini 4-5th Gen, iPad 3-6th Gen, iPad Pro 9.7"
  { width: 768, height: 1024, dpi: 2 },
];
